...
export default function AccessibilityPage() {
  return (
    <main style={{ padding: '3rem 2rem', maxWidth: 720, margin: '0 auto', lineHeight: 1.6 }}>
      ...
      <p>
        Where automated checks cannot verify intent, we rely on manual review. If a flow is
        broken for you, let us know — we treat accessibility bugs at the same severity as
        functional bugs.
      </p>
      <h2>Get in touch</h2>
      <p>
      ...
      <p style={{ color: '#666', fontSize: '0.9rem' }}>Last audited: see /legal/processors for date.</p>
    </main>
  );
}
