    ...
    <main>
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        <section className="mt-0">
          <h2 className="text-xl font-semibold text-fg">For jobseekers</h2>
          <ul className="mt-2 list-disc pl-5 text-fg-muted">
            <li>
              Upload a focused résumé — we parse it to autofill applications and score every job for
              you.
            </li>
        ...
        <section className="mt-8">
          <h2 className="text-xl font-semibold text-fg">For employers</h2>
          <ul className="mt-2 list-disc pl-5 text-fg-muted">
            <li>
              Write a clear title and detailed description — AI extracts the required skills on
              save.
            </li>
