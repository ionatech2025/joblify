...
export function AuthVisualPanel() {
  return (
    <div data-testid="auth-visual-panel" className="hidden p-6 lg:flex">
      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden rounded-canvas border border-border px-10 py-16 shadow-soft">
        ...
        <div className="relative flex flex-col items-center gap-10 text-center">
          <div aria-hidden="true">
            <Card tone="glass" className="w-72 -rotate-2 p-5 text-left">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="m-0 text-sm font-semibold text-fg">Senior Product Designer</p>
                  <p className="m-0 mt-1 text-xs text-fg-muted">Aurora Labs · Remote</p>
                </div>
          ...
          <p className="display m-0 max-w-sm text-3xl text-fg">Where careers find momentum.</p>
        </div>
      </div>
    </div>
  );
